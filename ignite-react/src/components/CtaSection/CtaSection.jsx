...
const CARDS = [
  {
    id: 'cta-find', href: '#branches', label: 'Tìm phòng tập gần bạn',
  ...
  {
    id: 'cta-membership', href: '#pricing', label: 'Khám phá gói hội viên',
    icon: (<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width="48" height="48">
  ...
  {
    id: 'cta-space', href: '#features', label: 'Không gian tập luyện',
    icon: (<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width="48" height="48">
        ...
        <div className="row g-3">
          {CARDS.map((card) => (
            <div key={card.id} className="col-12 col-md-4">
              <a id={card.id} href={card.href} className={`${styles.card} h-100`}>
